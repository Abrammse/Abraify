...
<img  className='rounded hover:scale-105  transition-all duration-300 cursor-pointer max-sm:w-11 gap ' src={index % 2=== 0 ? assets.sample_img_2 : assets.sample_img_1 } alt="start" key={index} width={120}  />

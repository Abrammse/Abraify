...
<button className='sm:text-lg text-white   bg-black w-auto mt-8 px-12 py-2.5 flex  items-center gap-2  rounded   ' >Generate Images <img src={assets.star_group} alt="start"/>
</button> 
     </div>
  );
}
